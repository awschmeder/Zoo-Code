...
When to use this vs run_slash_command: use skill to load a named skill directly. Use run_slash_command to run a named slash command; if no slash command matches the name, it falls back to resolving a skill of the same name. When you specifically intend to load a skill, prefer this tool.`
