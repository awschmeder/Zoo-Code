...
When to use this vs skill: run_slash_command is a specialized tool for running named slash commands. If no slash command matches the name, it falls back to resolving a skill of the same name. When you specifically intend to load a skill, prefer the primary skill tool directly.`
