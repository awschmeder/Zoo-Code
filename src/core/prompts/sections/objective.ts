...
6. To answer a question or acknowledge input when no other action is needed, call attempt_completion with the answer as the result. The "no questions / terminal" guidance governs how the result is phrased, not whether a tool is called.`
}
